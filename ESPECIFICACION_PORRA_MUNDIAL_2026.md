...
2. **Puntuación acumulativa de eliminatorias (a confirmar).** Una selección acertada hasta la final también "pasó" por 1/16, 1/8, 1/4 y semis. Interpretación adoptada: se puntúa en CADA ronda alcanzada (5+10+15+20+30 si llega a la final). Confirmar con el organizador, porque cambia mucho el techo de puntos.
...
4. **Empates en la clasificación de la porra.** Las reglas no definen desempate para los premios (40/20/10 %). Definir criterio (p. ej. nº de resultados exactos; si persiste, reparto).
